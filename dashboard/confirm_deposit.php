...
<head>
    ...
    <!-- Title -->
    <title>Confirm Investment - Bolt Trades</title>
                                                ...
                                                <form id="form_ms">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            if ($deposit['payment_method'] == "Bitcoin") {
                                                            ?>
                                                                <input type="text" name="wallet_address" disabled id="wallet_address" class="form-control " value="3NZHpukqyeWeijBj3CtQxgA9meKzL88JnQ">
                                                            <?php
                                                            } elseif ($deposit['payment_method'] == "Ethereum") {
                                                            ?>
                                                                <input type="text" name="wallet_address" disabled id="wallet_address" class="form-control " value="0xaE94FFb22e7Be4C4a363240576D5e9EA79712c45">
                                                            <?php
                                                            } elseif ($deposit['payment_method'] == "Dogecoin") {
                                                            ?>
                                                                <input type="text" name="wallet_address" disabled id="wallet_address" class="form-control " value="D63VPXS8RjAci8kTNkUs3cqPhxvKoAiSbj">
                                                            <?php
                                                            } elseif ($deposit['payment_method'] == "Litecoin") {
                                                            ?>
                                                                <input type="text" name="wallet_address" disabled id="wallet_address" class="form-control " value="MHmHnRXboKpgKYc1K7t5Un8ZgrZpmQ1pyJ">
                                                            <?php
                                                            } else {

                                                            ?>
                                                                <input type="text" value="qzp4nmdlytj8n98rx5t7m5g79lz2wwxnkvqqysvr30" name="wallet_address" disabled id="wallet_address" class="form-control ">
                                                            <?php
                                                            } ?>
