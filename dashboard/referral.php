...
<head>
  ...
  <!-- Title -->
  <title>Referrals - Bolt Trades</title>
            ...
            <div class="card" id="button7">
              ...
              <div class="settings-profile">
                   <center><p style="color: #ff231f ">Invite your friends and earn 5% commission  on their first deposit. Use the referal link below.</p></center>
                    ...
                    <div class="alert alert-primary"> <input type="text" style="width: 70%;background-color: transparent;outline: none;border: none;" value="https://www.bolttrades.com/register/<?= $user['referal_link'] ?>" id="myInput"/> <button onclick="myFunction()" class="btn btn-sm btn-primary"><span class="fa fa-copy"></span></button></div>
